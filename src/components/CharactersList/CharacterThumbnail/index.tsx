...
const CharacterThumbnail = ({
  ...
  <li
    ...
    className={`flex h-[190px] w-[120px] shrink-0 flex-col items-stretch gap-4 transition-all hover:scale-110 hover:cursor-pointer hover:shadow-[0px_0px_24px_5px] hover:shadow-brown-500 ${
